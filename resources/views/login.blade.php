...
<head>
    ...
    <link rel="stylesheet" href="{{ admin_asset("vendor/famio/adminlte3/plugins/font-awesome/css/font-awesome.min.css") }}">
    <link rel="stylesheet" href="{{ admin_asset("vendor/famio/adminlte3/dist/css/adminlte.min.css") }}">
</head>
...
<body class="hold-transition login-page" @if(config('admin.login_background_image'))style="background: url({{config('admin.login_background_image')}}) no-repeat;background-size: cover;"@endif>
    ...
    <script src="{{ admin_asset("vendor/famio/adminlte3/plugins/bootstrap/js/bootstrap.bundle.min.js")}}"></script>
</body>
